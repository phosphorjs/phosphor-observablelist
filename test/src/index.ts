...
describe('phosphor-observablelist', () => {

  describe('ObservableList', () => {

    describe('.changedSignal', () => {

      it('should be a Signal object', () => {
        expect(ObservableList.changedSignal instanceof Signal).to.be(true);
      });
